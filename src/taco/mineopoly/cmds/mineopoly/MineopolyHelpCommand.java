...
public class MineopolyHelpCommand extends TacoHelpCommand {
	...
	protected void initSpecific() {
		sOutput.put(new MineopolyEndTurnCommand(), "Ends your turn. \n\n&bPrecondition:\n\n" +
				"* You must be playing Mineopoly\n" +
		...
		sOutput.put(new MineopolyJoinCommand(), "Adds you to the game queue\n\n&bPrecondition:\n" +
		...
		sOutput.put(new MineopolyQueueCommand(), "Lists everyone in the game queue (not who is in the game)");

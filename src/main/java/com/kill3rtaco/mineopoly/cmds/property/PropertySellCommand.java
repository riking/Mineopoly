    ...
    public void onPlayerCommand(Player player, String[] args) {
        if (Mineopoly.plugin.getGame().isRunning()) {
            ...
            if (TacoAPI.getChatUtils().isNum(args[1])) {
                ...
                Mineopoly.plugin.getGame().getChannel().sendMessage("&b" + mp.getName() + " &3has requested to trade with &b" + trader.getName() + "&7: " + owned.getColorfulName() + " &7-> &2" + price, mp, trader);
            } else {

...
public class TradeAcceptCommand extends TacoCommand {
    ...
    public void onPlayerCommand(Player player, String[] args) {
        ...
        if (request.getType() == TradeType.SELL) {
            ...
            Mineopoly.plugin.getGame().getChannel().sendMessage("&b" + mp.getName() + " &3accept &b" + trader.getName() + "&3's trade request&7: " + "&2" + money + " &7-> " + section.getColorfulName(), mp, trader);
        } else {
            ...
            Mineopoly.plugin.getGame().getChannel().sendMessage("&b" + mp.getName() + " &3accept &b" + trader.getName() + "&3's trade request&7: " + requested.getColorfulName() + " &7-> " + offered.getColorfulName(), mp, trader);
        }

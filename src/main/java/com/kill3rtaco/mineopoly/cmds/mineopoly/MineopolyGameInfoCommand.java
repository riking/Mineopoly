...
public class MineopolyGameInfoCommand extends TacoCommand {
    ...
    public void onPlayerCommand(Player player, String[] args) {
        ...
        if (game.isRunning()) {
            ...
            Mineopoly.plugin.chat.sendPlayerMessage(player, "&3Time running&7: &d" + game.getTimeRunningString() + (Mineopoly.houseRules.timeLimit() < 0 ? " &b(" + game.getTimeLeftString() + " &3 left&b)" : ""));

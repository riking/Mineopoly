...
public enum MineopolyCardVariable {
    ...
    ID(".*%[0-9]+.*", new IdReplaceMethod()), RANDOM_DEV(".*%randomDev.*", new RandomDevReplaceMethod()), RANDOM_PLAYER(".*%randomPlayer.*", new RandomPlayerReplaceMethod()), RANDOM_SPACE(".*%randomSpace.*", new RandomSpaceReplaceMethod());

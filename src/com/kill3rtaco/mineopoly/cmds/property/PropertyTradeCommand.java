...
public class PropertyTradeCommand extends TacoCommand {
    ...
    public void onPlayerCommand(Player player, String[] args) {
        if (Mineopoly.plugin.getGame().isRunning()) {
            ...
            Mineopoly.plugin.getGame().getChannel().sendMessage("&b" + mp.getName() + " &3has requested to trade with &b" + trader.getName() + "&7: " + owned.getColorfulName() + " &7-> " + wanted.getColorfulName(), mp, trader);
        } else {
